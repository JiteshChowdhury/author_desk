        ...
        for(j=0;j<col;j++){
              for (let k = 0; k < poses.length; k++) {
                  ...
                  if((step*j <= poseKeypointX && poseKeypointX <= step*(j+1))&&(step*i <= poseKeypointY && poseKeypointY <= step*(i+1)))
                  {
                    fill(255);
                    noStroke();
                    rect(step*j, step*i, nStep, nStep);
                    nStepX = step*j + nOffset;
                    nStepY = step*i + nOffset;
                    ran = random(1,9.9); 
                    switch (int(ran)) {
                      case 1:
                        image(img1, nStepX, nStepY, nSize, nSize);
                        break;
                      case 2:
                        image(img2, nStepX, nStepY, nSize, nSize);
                        break;
                      case 3:
                        image(img3, nStepX, nStepY, nSize, nSize);
                        break;
                      case 4:
                        image(img4, nStepX, nStepY, nSize, nSize);
                        break;
                      case 5:
                        image(img5, nStepX, nStepY, nSize, nSize);
                        break;
                      case 6:
                        image(img6, nStepX, nStepY, nSize, nSize);
                        break;
                      case 7:
                        image(img7, nStepX, nStepY, nSize, nSize);
                        break;
                      case 8:
                        image(img8, nStepX, nStepY, nSize, nSize);
                        break;
                      case 9:
                        image(img9, nStepX, nStepY, nSize, nSize);
                        break;
                      default:
                        break;
                    }
